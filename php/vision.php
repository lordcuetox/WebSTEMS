...
<html lang="es">
    <head>
        <title>Sitio oficial del STEMS | Visión</title>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta name="keywords" content="STEMS" />
        <meta name="description" content="Sitio oficial del STEMS. Visión" />
        <!-- IE -->
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-10 col-md-offset-1 semblanza">
                    ...
                    <p class="text-justify">Consolidarnos como un organismo sindical comprometido con el bienestar y la protección civil y jurídica de nuestros agremiados, nutridos por la participación activa y constructiva de los mismos.</p> <p class="text-justify"></p></div>
